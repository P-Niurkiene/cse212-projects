public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: 1 Defect - Trying to remove from the queue from index 1
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: 1 - Defect : Adding to the front of the queue isntead of the back because of the term instert
