...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue was not FIFO
    ...
    // Defect(s) Found: Queue was in an incorrect order because it was not enqueued correctly
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: No coding allowing infinite turns, and incorrect FIFO
